...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ==================================================================================================
  // Question page
  const startButton = document.querySelector('.start-quiz-button button');
  ...
  */
  ...
  // ==================================================================================================
  const currentQuestionArray = []; // current Session Array
  const usedQuestionsArray = []; // used questions in this session
  ...
  const pausedTimeElement = document.querySelector('#pausedTimer');
